        ...
        <div id='skillsSection' className={styles.Carrusel}>
            ...
            <div className={styles.Carrusel__container}>
                <div className={styles.Carrusel__iconBoxContainer}>
                    ...
                    <div className={styles.Carrusel__iconBox}>
                        <img width="53" height="53" src="https://img.icons8.com/external-vectorslab-flat-vectorslab/53/external-Database-Management-seo-and-marketing-vectorslab-flat-vectorslab.png" alt="external-Database-Management-seo-and-marketing-vectorslab-flat-vectorslab"/>
                        DBMS
                    </div>
                    <div className={styles.Carrusel__iconBox}>
